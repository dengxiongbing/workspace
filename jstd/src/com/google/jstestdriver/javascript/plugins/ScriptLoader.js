...
jstestdriver.plugins.ScriptLoader.prototype.insertAfter = function(elemToBeInsert, posElem)
{
	var parentElem = posElem.parentNode;
	parentElem.appendChild(elemToBeInsert);
}
...
jstestdriver.plugins.ScriptLoader.prototype.load = function(file, callback) {
  ...
  var body = this.dom_.getElementsByTagName('body')[0];
